...
SCUT_ROOT = osp.join(HOME, "data/SCUT_HEAD_Part_B/")


class SCUTAnnotationTransform(object):
    """Transforms a SCUT annotation into a Tensor of bbox coords and label index
